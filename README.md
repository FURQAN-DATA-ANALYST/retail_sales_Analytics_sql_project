...
## Objectives
Develop a modern data warehouse using SQL Server to consolidate sales data, enabling analytical reporting and informed decsion-making.

## Specifications
- **Data Source**: Import data from (https://archive.ics.uci.edu/ml/datasets/Online+Retail+II) as excel file and converted into CSV files.
